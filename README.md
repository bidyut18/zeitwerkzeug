...
**Currently is Alpha phase . Not ready for production**
...
- `zeitwerkzeug.astro` – solar geometry and twilight calculations
- `zeitwerkzeug.context` – state-aware triggers and conditions
- `zeitwerkzeug.personas` – human-centered scheduling abstractions
- `zeitwerkzeug.daemon` – async scheduler logic
